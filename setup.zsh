...
[ $(uname -m) = x86_64 ] && curl -Lo ${HOME}/.local/bin https://kind.sigs.k8s.io/dl/v0.19.0/kind-darwin-amd64 
[ $(uname -m) = arm64 ] && curl -Lo ${HOME}/.local/bin https://kind.sigs.k8s.io/dl/v0.19.0/kind-darwin-arm64 
